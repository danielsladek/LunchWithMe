      ...
      [
        {
          ...
          surname: 'Doe',
          email: 'john.doe@lunchwithme.cz',
          facebookId: '555555555',
        },
        {
          createdAt: new Date(),
          updatedAt: new Date(),
          ...
          icon: 'https://static.xx.fbcdn.net/rsrc.php/v3/yo/r/UlIqmHJn-SK.gif',
          surname: 'Fenyk',
          email: 'tomas@lunchwithme.cz',
          facebookId: '666666666',
        },
        {
          createdAt: new Date(),
          updatedAt: new Date(),
          ...
          name: 'Marek',
          icon:
            'https://scontent.xx.fbcdn.net/v/t1.0-1/p80x80/14222227_10209192314719103_8607768522029368925_n.jpg?oh=d3b76abc34211ae1a49abfb4c4b8de6d&oe=5A9BDFD2',
          surname: 'Novy',
          email: 'marek@lunchwithme.cz',
          facebookId: '10213238493511044',
        },
        {
          createdAt: new Date(),
          updatedAt: new Date(),
          ...
          name: 'Daniel',
          icon:
            'https://scontent.xx.fbcdn.net/v/t1.0-1/p50x50/12744762_10205555401075372_3323371200062319048_n.jpg?oh=1f605c6cf68c7622cff3de34277cd31c&oe=5A99C640',
          surname: 'Sladek',
          email: 'daniel@lunchwithme.cz',
          facebookId: '10210121902915064',
        },
      ],
      {}
    )
